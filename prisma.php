...
<body>
  ...
  <div class="container">
    ...
    <br>
    <label for="height">Tinggi Prisma:</label>
    <input type="number" id="height" placeholder="Masukkan tinggi prisma">
    <br>
  ...
  <script>
    function calculate() {
      ...
      if (base > 0 && height > 0) {
        ...
        var surfaceArea = 2 * base + (base * height * 3);

        document.getElementById("result").innerHTML = "Volume: " + volume.toFixed(2) + "<br>Luas Permukaan: " + surfaceArea.toFixed(2);
      } else {
        document.getElementById("result").innerHTML = "Masukkan nilai yang valid untuk luas alas dan tinggi prisma";
      }
    }
  </script>
</body>
